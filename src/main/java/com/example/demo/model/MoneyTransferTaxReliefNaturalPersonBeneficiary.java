...
public class MoneyTransferTaxReliefNaturalPersonBeneficiary {
	...
	public MoneyTransferTaxReliefNaturalPersonBeneficiary() {
		super();
	}

	public MoneyTransferTaxReliefNaturalPersonBeneficiary(String fiscalCode1, String fiscalCode2, String fiscalCode3,
			String fiscalCode4, String fiscalCode5) {
		super();
	...
	public String toString() {
		return "MoneyTransferTaxReliefNaturalPersonBeneficiary [fiscalCode1=" + fiscalCode1 + ", fiscalCode2="
				+ fiscalCode2 + ", fiscalCode3=" + fiscalCode3 + ", fiscalCode4=" + fiscalCode4 + ", fiscalCode5="
				+ fiscalCode5 + "]";
	}
